resource "aws_elasticache_subnet_group" "this" {
  ...
  tags        = var.TAGS != null ? "${merge(var.TAGS, { Name = "${var.PROJECT_NAME} Elasticache Subnet Group" })}" : { Name = "${var.PROJECT_NAME} Elasticache Subnet Group" }
}
...
resource "aws_elasticache_cluster" "this" {
  ...
  tags                         = var.TAGS != null ? "${merge(var.TAGS, { Name = "${var.PROJECT_NAME} Elasticache Cluster" })}" : { Name = "${var.PROJECT_NAME} Elasticache Cluster" }
}
